/**
 * RegimeLab API client.
 *
 * Connects to the FastAPI backend. The base URL is configured via
 * the VITE_API_BASE_URL environment variable (defaults to localhost:8000).
 */
